...
# --------------------
@app.route('/api/get_endtest_result_report', methods=['POST'])
@token_required
def get_endtest_result_report():
    # Define the path to the Excel template (modify this path accordingly)
    template_path = r'/data-storage/sfdc_apps/excel_import/endtest_report_template.xlsx'
    ...
    try:
        ...
        return Response(
            ...
            headers={
                'Content-Disposition': 'attachment; filename=endtest_report.xlsx'
            }
        )
