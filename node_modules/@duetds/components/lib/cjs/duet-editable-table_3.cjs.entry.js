  ...
  constructor(hostRef) {
    ...
    this.getItemHTMLFromItemData = (data, group) => {
      if (group === this.DefaultGroups.success) {
        ...
        return index.h(ErrorItem, { data: data, errorCodes: this.errorCodes });
      }
      else if (data.group) {
        return data.html;
      }
