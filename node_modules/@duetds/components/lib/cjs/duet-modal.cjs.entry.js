...
const DuetModal = class {
  constructor(hostRef) {
    ...
    this.duetBeforeClose = index.createEvent(this, "duetBeforeClose", 7);
    var _a, _b;
    /**
     * Own Properties.
     */
    this.modalId = createId.createID("DuetModal");
    this.slotDefaultId = createId.createID("DuetModal-default-slot");
  ...
  openChanged() {
    if (this.open) {
      ...
      bodyScrollLock_es6.disableBodyScroll(this.modalEl, { reserveScrollBarGap: true });
      setTimeout(() => {
      ...
      bodyScrollLock_es6.enableBodyScroll(this.modalEl);
      this.duetClose.emit();
      setTimeout(() => {
        focusUtils.focusElement(this.focusedElBeforeOpen);
      }, TRANSITION_MS);
      if (this.isAndroidDevice) {
  ...
  render() {
    ...
    return (index.h("div", { ref: modal => (this.modalEl = modal), "aria-labelledby": this.heading ? this.modalId : false, "aria-details": this.accessibleDetails, "aria-description": this.accessibleDescription, "aria-describedby": this.accessibleDescribedBy ? `${this.slotDefaultId} ${this.accessibleDescribedBy}` : this.slotDefaultId, role: "dialog", "aria-modal": this.isSafariBrowser ? false : true, tabindex: "-1", "aria-flowto": this.slotDefaultId, class: {
      ...
      } }, index.h("div", { class: "duet-modal-header" }, index.h("span", { class: "duet-modal-inner-slot-top" }, index.h("slot", { name: "top" })), this.icon && index.h("duet-icon", { name: this.icon, size: "xx-large", color: this.color || iconColor }), this.heading && (index.h("duet-heading", { level: this.headingLevel, theme: this.theme, id: this.modalId }, this.heading))), index.h("span", { class: "duet-modal-inner-slot-default", id: this.slotDefaultId }, index.h("slot", null))))), index.h(focusUtils.FocusGuard, { moveFocusTo: this.buttonEl })));
  }
