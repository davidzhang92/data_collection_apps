...
const colors = {
  turva: {
    active: tokens_module.colorPrimaryTurva,
    inactive: tokens_module.colorGrayTurva,
  },
  default: {
    active: tokens_module.colorPrimary,
    inactive: tokens_module.colorGray,
  },
};
const DuetRangeSlider = class {
  constructor(hostRef) {
     ...
     * Own Properties
     */
    this.rangeId = createId.createID("DuetRange");
    /**
     * Theme of the input.
     */
    this.theme = "";
  ...
  render() {
    ...
    return (index.h(index.Host, { class: { "duet-m-0": this.margin === "none", "duet-expand": this.expand } }, index.h("div", { class: {
        "duet-range-container": true,
        "duet-label-hidden": this.labelHidden,
        "duet-theme-turva": this.theme === "turva",
        "duet-ie": isInternetExplorer.isInternetExplorer(),
        "duet-range-disabled": this.disabled,
      } }, index.h("duet-label", { theme: theme, margin: "small", for: identifier }, this.label), index.h("output", { "aria-hidden": "true", htmlFor: identifier, class: "duet-output" }, this.value.toLocaleString(this.locale), this.unit), index.h("input", { onInput: this.onInput, onChange: this.onChange, ref: input => (this.nativeInput = input), type: "range", min: this.min, max: this.max, step: this.step, value: this.value, style: rangeStyles, "aria-valuemin": this.min, "aria-valuemax": this.max, "aria-valuenow": this.value, "aria-valuetext": `${this.value} ${this.unit}`, "aria-controls": this.accessibleControls, "aria-activedescendant": this.accessibleActiveDescendant, "aria-owns": this.accessibleOwns, "aria-describedby": this.accessibleDescribedBy, id: identifier, name: this.name, disabled: this.disabled, required: this.required, class: "duet-range" }))));
  }
