...
const DuetStep = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.duetStepClick = index.createEvent(this, "duetStepClick", 7);
    this.buttonId = createId.createID("DuetStepButton");
    this.contentId = createId.createID("DuetStepContent");
    /**
  ...
  renderStepCounter() {
    if (this.state === "complete" || this.state === "disabled") {
      return (index.h("div", { class: "duet-step-icon" }, index.h("duet-icon", { margin: "none", size: "auto", color: "gray-lightest", icon: actionEdit2.svg })));
    }
...
const DuetStepper = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.duetStepChange = index.createEvent(this, "duetStepChange", 7);
    /**
     * Theme of the component.
     */
    this.theme = "";
   ...
   */
  render() {
    return (index.h(index.Host, { class: { "duet-m-0": this.margin === "none" } }, index.h("div", { class: { "duet-stepper": true, "duet-theme-turva": this.theme === "turva" } }, index.h("duet-visually-hidden", { "aria-live": "polite", "aria-atomic": "true", "aria-relevant": "all" }, this.formatAnnouncement()), index.h("slot", null))));
  }
  get element() { return index.getElement(this); }
...
exports.duet_step = DuetStep;
exports.duet_stepper = DuetStepper;
