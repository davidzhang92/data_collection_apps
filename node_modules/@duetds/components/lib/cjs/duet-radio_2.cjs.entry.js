...
const DuetRadioGroup = class {
  ...
  async connectedCallback() {
    ...
    if (this.value === undefined) {
      const radio = watchOptions.findCheckedOption(el, "duet-radio");
      if (radio !== undefined) {
    ...
    this.mutationO = watchOptions.watchForOptions(el, "duet-radio", newOption => {
