...
const DuetCookieConsent = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.duetCookieConsent = index.createEvent(this, "duetCookieConsent", 7);
    /**
   ...
   */
  render() {
    return (index.h(index.Host, { tabindex: "0" }, index.h("div", { class: { "duet-cookie-consent": true, "duet-theme-turva": this.theme === "turva" } }, index.h("div", { class: "duet-cookie-consent-content" }, index.h("div", { class: "expand" }, index.h("slot", null)), index.h("duet-spacer", { size: "large", direction: "horizontal" }), index.h("div", null, index.h("duet-button", { variation: "negative", size: "small", onClick: this.handleClick, margin: "none", "aria-label": this.accessibleLabel, theme: this.theme }, "OK"))))));
  }
  get element() { return index.getElement(this); }
};
DuetCookieConsent.style = duetCookieConsentCss;

exports.duet_cookie_consent = DuetCookieConsent;
