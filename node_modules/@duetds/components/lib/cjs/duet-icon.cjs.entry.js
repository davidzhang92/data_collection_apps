...
const DuetIcon = class {
  ...
  render() {
    const color = this.color === "currentColor"
      ? "currentColor"
      : tokenUtils.getColorByName(this.color, this.theme) || tokenUtils.getColorByName(this.outline, this.theme);
    const styles = {
      color,
      background: tokenUtils.getColorByName(this.background, this.theme),
      "border-color": tokenUtils.getColorByName(this.outline, this.theme),
    };
    return (index.h(index.Host, { class: {
        "duet-m-0": this.margin === "none",
        "duet-icon-has-outline": !!this.outline,
        "duet-icon-has-background": !!this.background,
      } }, index.h("div", { "aria-hidden": "true", style: styles, class: {
        "duet-icon": true,
        [this.size]: true,
      ...
      } }, index.h("span", { "aria-hidden": "true", class: "duet-icon-svg", innerHTML: this.svgContent }))));
  }
