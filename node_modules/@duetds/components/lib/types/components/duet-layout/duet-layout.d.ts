...
import { DuetMargin } from "../../common-types";
export declare type DuetLayoutStickyDistance = "with-links" | "without-links";
/**
 ...
 */
export declare class DuetLayout implements ComponentInterface {
  /**
   * Own Properties.
   */
  private hasSidebar;
