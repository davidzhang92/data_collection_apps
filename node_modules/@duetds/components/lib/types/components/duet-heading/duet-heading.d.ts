import { DuetColor, DuetHeadingLevel, DuetMargin, DuetTheme, DuetVisualHeadingLevel } from "../../common-types";
import { ThemeableComponent } from "../../common/themeable-component";
export declare type DuetHeadingWeight = "auto" | "normal" | "semibold";
export declare class DuetHeading implements ThemeableComponent {
  /**
  ...
  margin: DuetMargin;
  /**
   * Make the visual style mimic a specific heading level. This option allows
