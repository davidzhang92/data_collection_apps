...
import { DuetStepClickEvent } from "../duet-step/duet-step";
export declare type DuetStepChangeEvent = {
  component: "duet-stepper";
  fromStep: number;
  toStep: number;
};
export declare class DuetStepper implements ThemeableComponent {
  /**
   ...
   */
  selected: number;
  currentStepChanged(nextStep: any): void;
  currentStepInvokedDisable(): void;
  /**
