...
export declare type DuetSelectOption = {
  label: string;
  value: string;
  disabled?: boolean;
};
...
export declare type DuetSelectItems = Array<DuetSelectOptionGroup | DuetSelectOption>;
export declare type DuetSelectEvent = {
  originalEvent?: Event;
