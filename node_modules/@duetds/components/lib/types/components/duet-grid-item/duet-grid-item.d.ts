import { DuetGridBreakpoint, DuetMargin, DuetTheme } from "../../common-types";
import { ThemeableComponent } from "../../common/themeable-component";
export declare class DuetGridItem implements ThemeableComponent {
  /**
   * Make the grid item fill the remaining available grid space.
   */
  fill: boolean;
  /**
   * Sets the maximum width for the grid item using any valid numeric CSS
   * value. E.g. "300px".
   */
  maxWidth: string;
  /**
   * Sets the minimum width for the grid item using any valid numeric CSS
   * value. E.g. "33.333%".
   */
  minWidth: string;
  /**
