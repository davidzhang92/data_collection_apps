...
export declare type DuetChoiceEvent = {
  originalEvent?: Event;
  checked: boolean;
  value: string;
  component: "duet-choice";
};
export declare type DuetChoiceType = "radio" | "checkbox";
/**
 ...
 */
export declare class DuetChoice implements ThemeableComponent, InputComponent, A11yComponent {
  /**
   * Own Properties.
   */
  private hasInfo?;
  ...
  /**
   * @internal
   * Determines whether the control is displayed horizontally or vertically within
   * a group.
   */
  ...
  /**
   * @internal
   * Determines whether the group has responsive behavior
   */
   ...
   */
  duetChange: EventEmitter<DuetChoiceEvent>;
  /**
   * Emitted when the checkbox has focus.
   */
  duetFocus: EventEmitter<DuetChoiceEvent>;
  /**
   * Emitted when the checkbox loses focus.
   */
  duetBlur: EventEmitter<DuetChoiceEvent>;
  /**
