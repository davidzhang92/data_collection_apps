...
export declare type DuetTextareaEvent = {
  originalEvent?: Event;
  component: "duet-textarea";
  value: string;
};
export declare class DuetTextarea implements ThemeableComponent, InputComponent, A11yComponent {
  /**
   * Own Properties
   */
  private textareaId;
  ...
  counter: boolean;
  /**
   * Accessible label for character counter. Must be used in conjunction with
   * **counter** property.
   */
  counterLabel: string;
  /**
   ...
   */
  duetInput: EventEmitter<DuetTextareaEvent>;
  /**
   * Emitted when the value has changed.
   */
  duetChange: EventEmitter<DuetTextareaEvent>;
  /**
   * Emitted when the input loses focus.
   */
  duetBlur: EventEmitter<DuetTextareaEvent>;
  /**
   * Emitted when the input has focus.
   */
  duetFocus: EventEmitter<DuetTextareaEvent>;
  /**
