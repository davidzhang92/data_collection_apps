...
import { DuetDirection, DuetMargin, DuetTheme } from "../../common-types";
export declare type DuetRadioEvent = {
  originalEvent?: Event;
  checked: boolean;
  value: string;
  component: "duet-radio";
};
export declare class DuetRadio implements ThemeableComponent, InputComponent, A11yComponent {
  /**
   * Own Properties.
   */
  private radioId;
  ...
  /**
   * Control the tabindex of checkbox. In most cases this should never be used!
  ...
  /**
   * @internal
   * Determines, whether the control is displayed responsively within a group.
   */
  ...
  checked: boolean;
  /**
   * The value of the radio input does not mean if it's checked or not, use the checked
   * property for that.
   */
  value: string;
  /**
   ...
   */
  duetChange: EventEmitter<DuetRadioEvent>;
  /**
   * Emitted when the checkbox has focus.
   */
  duetFocus: EventEmitter<DuetRadioEvent>;
  /**
   * Emitted when the checkbox loses focus.
   */
  duetBlur: EventEmitter<DuetRadioEvent>;
  /**
