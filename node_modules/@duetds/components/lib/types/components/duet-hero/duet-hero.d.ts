...
export declare type DuetHeroIconSize = "medium" | "large";
export declare type DuetHeroVariation = "default" | "light" | "gray" | "image" | "minimal";
export declare type DuetHeroBackData = {
  analyticsId?: string;
  id?: string;
  href: string;
  label: string;
};
export declare type DuetHeroClickEvent = {
  originalEvent: Event;
  component: "duet-hero";
  data: any;
};
export declare type DuetHeroAnalyticsEvent = DuetAnalyticsEvent<"duet-hero">;
export declare type DuetHeroButtonData = {
  analyticsId?: string;
  [key: string]: any;
};
export declare type DuetHeroListItem = {
  label: string;
  value: string;
};
export declare type DuetHeroActionItem = {
  label: string;
  href: string;
  icon: string;
  id?: string;
