...
export declare class DuetCheckbox implements ThemeableComponent, InputComponent, A11yComponent {
  /**
   * Own Properties.
   */
  private checkboxId;
  ...
  /**
   * Control the tabindex of checkbox. In most cases this should never be used! It
   ...
   */
  duetChange: EventEmitter<DuetCheckboxEvent>;
  /**
   * Emitted when the checkbox has focus.
   */
  duetFocus: EventEmitter<DuetCheckboxEvent>;
  /**
   * Emitted when the checkbox loses focus.
   */
  duetBlur: EventEmitter<DuetCheckboxEvent>;
  /**
