...
export class DuetCheckbox {
  ...
  static get properties() { return {
    ...
    "accessibleIndex": {
      ...
      "docs": {
        "tags": [],
        "text": "Control the tabindex of checkbox. In most cases this should never be used! It\nexists only for Duet\u2019s internal needs."
      },
    ...
    "accessibleDescribedBy": {
      ...
      "docs": {
        "tags": [],
        "text": "Indicates the id of a component that describes the checkbox."
      },
    ...
    "disabled": {
      ...
      "docs": {
        "tags": [],
        "text": "Makes the checkbox component disabled. This prevents users from being able to\ninteract with the checkbox, and conveys its inactive state to assistive technologies."
      },
      "attribute": "disabled",
      "reflect": true,
      "defaultValue": "false"
  ...
  static get events() { return [{
      ...
      "complexType": {
        "original": "DuetCheckboxEvent",
        "resolved": "{ originalEvent?: Event; checked: boolean; value: string; component: \"duet-checkbox\"; }",
        "references": {
          "DuetCheckboxEvent": {
            "location": "local"
          }
  ...
  static get methods() { return {
    "setFocus": {
      ...
      "docs": {
        "text": "Sets focus on the specified `duet-checkbox`. Use this method instead of the global\n`input.focus()`.",
        "tags": []
      }
    }
  }; }
