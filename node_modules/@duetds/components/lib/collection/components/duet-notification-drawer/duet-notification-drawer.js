...
export class DuetNotificationDrawer {
  ...
  render() {
    return (h("div", { class: {
      ...
      h("button", { ref: el => (this.drawerButtonEl = el), type: "button", class: "duet-drawer-toggle", id: "duet-drawer-toggle", "aria-controls": "duet-drawer-content", "aria-expanded": this.isOpen ? "true" : "false", onClick: this.toggleMenu },
        this.icon && (h("div", { class: "duet-drawer-icon" },
          h("duet-icon", { margin: "none", size: "x-small", name: this.icon, color: "currentColor" }),
          this.badge && h("div", { class: "duet-drawer-badge" }))),
        h("span", { class: "duet-drawer-label" }, this.label),
        h("div", { class: "duet-drawer-caret" },
          h("duet-icon", { margin: "none", size: "auto", icon: arrowDownIcon.svg, color: "currentColor" }))),
      h("div", { id: "duet-drawer-content", class: {
        ...
        }, ref: element => (this.drawerContentEl = element) }, this.hasNotifications ? (h("div", { role: "list" },
        h("slot", null))) : (h("duet-empty-state", { size: "small" },
        h("duet-paragraph", { size: "small", margin: "none" }, this.accessibleLabelNotifications))))));
  }
