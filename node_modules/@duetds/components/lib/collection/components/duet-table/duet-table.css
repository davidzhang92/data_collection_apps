...
duet-table.duet-theme-turva td {
  color: #171c3a;
}
duet-table th {
  font-weight: 600;
...
.duet-table-striped td,
.duet-table-striped th {
...
.duet-table-striped tbody th {
  background: white;
}
.duet-table-striped.duet-table-sticky thead th {
  border-bottom: 1px solid #e1e3e6;
}
.duet-table-striped.duet-table-sticky.duet-theme-turva thead th {
  border-bottom-color: #e4e4e6;
}
.duet-table-striped tbody:not(:first-of-type) th {
  padding-top: 40px !important;
}
.duet-table-striped tbody:only-of-type tr:nth-of-type(odd) {
  background: rgba(0, 80, 128, 0.04);
}
.duet-table-striped.duet-theme-turva tbody:only-of-type tr:nth-of-type(odd) {
  background: rgba(23, 28, 58, 0.04);
}
.duet-table-striped tbody:not(:only-of-type) tr:nth-of-type(even) {
  background: rgba(0, 80, 128, 0.04);
}
.duet-table-striped.duet-theme-turva tbody:not(:only-of-type) tr:nth-of-type(even) {
  background: rgba(23, 28, 58, 0.04);
}
.duet-table-striped tfoot td {
  border-top: 1px solid #e1e3e6;
}
.duet-table-striped.duet-theme-turva tfoot td {
  border-top-color: #e4e4e6;
}
.duet-table-striped.duet-table-flattened tbody:not(:first-of-type) th {
  padding-top: 20px !important;
}
.duet-table-striped.duet-table-flattened tr {
  padding: 20px !important;
}
.duet-table-striped.duet-table-flattened tfoot td {
  border-top: 0;
}
.duet-table-striped.duet-table-flattened tfoot tr {
  border-top: 1px solid #e1e3e6;
}
...
.duet-table-plain.duet-table-flattened tbody tr {
  border-bottom: 1px solid #e1e3e6;
}
...
.duet-table-minimal tbody tr,
.duet-table-minimal tbody tr td {
  vertical-align: top;
  border-bottom: 0 none;
}
.duet-table-minimal tbody tr:last-of-type,
.duet-table-minimal tbody tr:last-of-type td {
  border-bottom: 1px solid #e1e3e6;
}
.duet-table-minimal.duet-table-flattened tbody tr,
.duet-table-minimal.duet-table-flattened tbody tr td {
  border-bottom: 0 none;
}
.duet-table-minimal.duet-table-flattened tbody tr td[data-heading]::before {
  display: none;
}
.duet-table-minimal.duet-table-flattened tfoot {
  border-top: 1px solid #e1e3e6;
}
