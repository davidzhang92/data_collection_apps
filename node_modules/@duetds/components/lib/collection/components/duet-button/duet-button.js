...
export class DuetButton {
  ...
  render() {
    ...
    const commonChildren = (h("span", { class: "duet-button-contents", style: { color: getColorByName(this.color) } },
      icon && (h("div", { "aria-hidden": "true", class: {
          "duet-button-icon": true,
          left: !iconRight,
          right: iconRight,
          [this.iconSize]: true,
        } },
        h("duet-icon", { size: "auto", margin: "none", name: icon, color: "currentColor" }))),
      h("slot", null)));
    const commonProps = {
