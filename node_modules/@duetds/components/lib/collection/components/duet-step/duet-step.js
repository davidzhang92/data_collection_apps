...
export class DuetStep {
  ...
  renderStepCounter() {
    if (this.state === "complete" || this.state === "disabled") {
      return (h("div", { class: "duet-step-icon" },
        h("duet-icon", { margin: "none", size: "auto", color: "gray-lightest", icon: editIcon.svg })));
    }
    ...
    if (Build.isBrowser) {
      return (h("div", { class: {
        ...
        h("div", { class: "duet-step-heading", id: this.buttonId, role: this.state !== "current" ? "button" : "region", "aria-current": this.state === "current" ? "step" : undefined, tabindex: this.state !== "current" ? "0" : undefined, "aria-disabled": this.isClickDisabled().toString(), "aria-expanded": (this.state === "current").toString(), "aria-controls": this.contentId, "aria-selected": (this.state === "current").toString(), onClick: this.handleClick, onKeyDown: this.handleKeyDown, ref: element => (this.buttonElement = element) },
          ...
          h("duet-spacer", { direction: "horizontal", size: "medium", breakpoint: "x-small" }),
          h("div", null,
            h("duet-heading", { theme: this.theme, level: this.headingLevel, visualLevel: "h4", color: this.headingColor(), margin: "none" }, this.heading)),
          h("duet-spacer", { direction: "horizontal", size: "large" }),
          h("div", { class: "duet-step-heading-slot" },
            h("slot", { name: "heading-content" }))),
        h("div", { class: "duet-step-content-wrapper" },
          h("div", { class: "duet-step-content", role: "region", "aria-labelledby": this.buttonId, id: this.contentId },
            h("slot", null)))));
    }
  }
  ...
  static get events() { return [{
      ...
      "complexType": {
        ...
        "resolved": "{ originalEvent: MouseEvent | KeyboardEvent; component: \"duet-step\"; stepIndex: number; }",
        "references": {
          "DuetStepClickEvent": {
            "location": "local"
          }
