...
const CharacterCount = ({ value, maxlength, label, theme }) => {
  ...
  return (h("div", { class: "duet-character-count" },
    h("duet-caption", { margin: "none", theme: theme, size: "small" },
      h("duet-visually-hidden", { "aria-live": "polite", "aria-atomic": "true", class: "duet-textarea-counter-remaining" }, isApproachingLimit && `${remainder} ${label}`),
    ...
    return (h(Host, { class: {
      ...
      h("div", { class: {
        ...
        h("duet-grid", { alignment: "stretch" },
          ...
          h("duet-grid-item", { margin: "none", class: "duet-character-count-caption" }, this.counter && (h(CharacterCount, { theme: this.theme, value: this.value, maxlength: this.maxlength, label: this.counterLabel })))))));
  }
