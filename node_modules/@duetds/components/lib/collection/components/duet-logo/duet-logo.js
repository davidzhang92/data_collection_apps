...
const DefaultLogo = ({ inverse, logoId, language }) => {
  ...
  return (h("svg", { role: "img", xmlns: "http://www.w3.org/2000/svg", fill: logoColor, "aria-labelledby": logoId, viewBox: viewBox },
    h("title", { id: logoId }, title),
    h("path", { d: path })));
};
export class DuetLogo {
  constructor() {
    /**
     * Own Properties.
     */
  ...
  render() {
    ...
    return (h(Host, { class: { "duet-m-0": this.margin === "none" } },
      h(TagName, { href: this.href, ref: link => (this.nativeLink = link), class: {
          "duet-logo": true,
          [this.size]: true,
  ...
  static get is() { return "duet-logo"; }
  ...
  static get properties() { return {
    ...
    "inverse": {
      ...
      "docs": {
        "tags": [],
        "text": "Use inverse version of the logo (white logo on dark background)."
      },
      "attribute": "inverse",
      "reflect": false,
      "defaultValue": "false"
    ...
    "size": {
      ...
      "docs": {
        "tags": [],
        "text": "Size variation of the logo."
      },
      "attribute": "size",
      "reflect": false,
      "defaultValue": "\"medium\""
  ...
  static get methods() { return {
    "setFocus": {
      ...
      "docs": {
        "text": "Sets focus on the specified `duet-logo`. Use this method instead of the global\n`logo.focus()`.",
        "tags": []
      }
    }
  }; }
