...
export class DuetTray {
  ...
  render() {
    return (h("div", { class: {
      ...
      h("div", { class: "duet-tray-default-content", role: "status" },
        h("slot", null)),
      this.hasAdditionalContent && (h(Fragment, null,
        h("button", { "aria-expanded": this.expanded ? "true" : "false", "aria-controls": this.expandableId, onClick: ev => this.toggleExpandable(ev), class: { "duet-tray-button": true, "duet-tray-is-expanded": this.expanded } },
          h("duet-icon", { name: "action-arrow-down", size: "small", color: "currentColor", margin: "none" }),
          h("duet-visually-hidden", null, this.expanded ? this.accessibleCloseLabel : this.accessibleOpenLabel)),
        h("div", { id: this.expandableId, class: { "duet-tray-expandable": true, active: this.expanded } },
          h("div", { class: "duet-tray-expandable-content" },
