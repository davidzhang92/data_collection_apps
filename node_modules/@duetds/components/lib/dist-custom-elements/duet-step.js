...
import { d as defineCustomElement$4 } from './p-260d7413.js';
...
const DuetStep$1 = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
  ...
  renderStepCounter() {
    if (this.state === "complete" || this.state === "disabled") {
      return (h("div", { class: "duet-step-icon" }, h("duet-icon", { margin: "none", size: "auto", color: "gray-lightest", icon: actionEdit2.svg })));
    }
...
function defineCustomElement$1() {
  ...
  const components = ["duet-step", "duet-heading", "duet-icon", "duet-spacer"];
  components.forEach(tagName => { switch (tagName) {
    case "duet-step":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, DuetStep$1);
      }
      break;
    case "duet-heading":
      if (!customElements.get(tagName)) {
...
const DuetStep = DuetStep$1;
const defineCustomElement = defineCustomElement$1;

export { DuetStep, defineCustomElement };
