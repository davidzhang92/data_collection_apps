.duet-background-warning {
  ...
  .duet-font-family-heading-turva {
    font-family: "turva-sans", -apple-system, BlinkMacSystemFont, "Segoe UI",
  ...
  .duet-font-family-heading {
    font-family: "localtapiola-sans", -apple-system, BlinkMacSystemFont,
  ...
  .duet-shadow-card-turva {
    box-shadow: 0 2px 6px 0 rgba(117, 117, 117, 0.13),
      0 -1px 0 0 rgba(0, 0, 0, 0.09), -1px 0 0 0 rgba(0, 0, 0, 0.07),
      1px 0 0 0 rgba(0, 0, 0, 0.07), 0 1px 0 0 rgba(0, 0, 0, 0.07) !important;
  }
  .duet-shadow-modal {
    box-shadow: 0 2px 20px 0 rgba(0, 0, 0, 0.2) !important;
  }
  .duet-shadow-card {
    box-shadow: 0 2px 6px 0 rgba(0, 41, 77, 0.07), 0 -1px 0 0 rgba(0, 0, 0, 0.09),
      -1px 0 0 0 rgba(0, 0, 0, 0.07), 1px 0 0 0 rgba(0, 0, 0, 0.07),
      0 1px 0 0 rgba(0, 0, 0, 0.07) !important;
  }
