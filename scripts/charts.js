...
$(document).ready(function() {
    ...
    function processData(apiData) {
        ...
        const datasets = [
            { label: 'Programming', data: [], backgroundColor: 'rgba(19, 75, 240, 0.8)', borderColor: 'rgba(255, 99, 132, 1)' },
            { label: 'Leaktest', data: [], backgroundColor: 'rgba(0, 255, 255, 0.8)', borderColor: 'rgba(54, 162, 235, 1)' },
            { label: 'Endtest', data: [], backgroundColor: 'rgba(216, 237, 55, 0.8)', borderColor: 'rgba(54, 162, 235, 1)' },
            { label: 'Laser', data: [], backgroundColor: 'rgba(89, 235, 63, 0.8)', borderColor: 'rgba(54, 162, 235, 1)' },
            { label: 'OQC', data: [], backgroundColor: 'rgba(164, 60, 230, 0.8)', borderColor: 'rgba(54, 162, 235, 1)' },
